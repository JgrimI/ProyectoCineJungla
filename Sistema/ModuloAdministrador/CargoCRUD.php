        ...
        <div class="page-container">
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				if(mysqli_num_rows($cek) == 0){
                    ...
                    $delete = mysqli_query($con, "DELETE FROM CARGO WHERE cod_cargo ='$nik'");
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Cargos</h3>
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a class="au-btn au-btn-icon au-btn--green au-btn--small" href='CargoAgregar.php?mensaje=<?php echo $mensaje?>'><i class="zmdi zmdi-plus"></i>Agregar Cargo</a>
			    ...
			    if($filter)
				{
				$sql = mysqli_query($con, "SELECT * FROM CARGO WHERE nom_cargo LIKE '%$filter%' ORDER BY nom_cargo ASC");
				}
			    else
				{
				$sql = mysqli_query($con, "SELECT * FROM CARGO ORDER BY nom_cargo ASC");
				}
                            ...
                            <tr class=tr-shadow">
                                ...
                                <td>
                                    <div class="table-data-feature">
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="CargoEditar.php?aksi=delete&nik='.$row['cod_cargo'].'&mensaje='.$mensaje.'">

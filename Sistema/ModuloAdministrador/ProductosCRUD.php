        ...
        <div class="page-container">
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				if(mysqli_num_rows($cek) == 0){
                    ...
                    $delete = mysqli_query($con, "DELETE FROM SNACKS WHERE cod_snack ='$nik'");
            ...
            <div class="main-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a class="au-btn au-btn-icon au-btn--green au-btn--small" href='ProductosAgregar.php?mensaje=<?php echo $mensaje?>'><i class="zmdi zmdi-plus"></i>Agregar producto</a>
                                            <div class="rs-select2--dark rs-select2--sm rs-select2--dark2">
                                                <select class="js-select2" name="formato">
			    ...
			    if($filter)
				{
				$sql = mysqli_query($con, "SELECT * FROM SNACKS WHERE nom_snack LIKE '%$filter%' ORDER BY nom_snack ASC");
				}
			    else
				{
				$sql = mysqli_query($con, "SELECT * FROM SNACKS ORDER BY nom_snack ASC");
				}
					...
					while($row = mysqli_fetch_assoc($sql)){
                        ...
                        <tbody>
                            <tr class=tr-shadow">
                                <td>'.$no.'</td>
                                <td>'.$row['nom_snack'].'</td>
                                <td>'.$row['tipo_snack'].'</td>
                                <td>'.$row['val_snack'].'</td>
                                <td>
                                    <div class="table-data-feature">
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="ProductosEditar.php?aksi=delete&nik='.$row['cod_snack'].'&mensaje='.$mensaje.'">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Delete" href="ProductosCRUD.php?aksi=delete&nik='.$row['cod_snack'].'&mensaje='.$mensaje.'">

                        ...
                        <div class="login-form">
                            <form class="form-horizontal" enctype="multipart/form-data" action="" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full" type="text" name="correo" placeholder="Correo electrónico" value="<?php echo $row ['correo_cliente']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Teléfono</label>
                                    <input class="au-input au-input--full" type="text" name="telefono" placeholder="Teléfono" value="<?php echo $row ['tel_cliente']; ?>">
                                </div>

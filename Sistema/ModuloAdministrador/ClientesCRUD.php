    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				$cek = mysqli_query($con, "SELECT * FROM CLIENTES WHERE cod_cliente ='$nik'");
				if(mysqli_num_rows($cek) == 0){
					echo 'No se puedo eliminar';
				}else{
                    $delete = mysqli_query($con, "DELETE FROM CLIENTES WHERE cod_cliente ='$nik'");
            ...
            <div class="main-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a class="au-btn au-btn-icon au-btn--green au-btn--small" href='ClientesAgregar.php?mensaje=<?php echo $mensaje?>'><i class="zmdi zmdi-plus"></i>Agregar cliente</a>
			    ...
			    if($filter)
				{
				$sql = mysqli_query($con, "SELECT * FROM CLIENTES WHERE nom_cliente LIKE '%$filter%' ORDER BY nom_cliente ASC");
				}
			    else
				{
				$sql = mysqli_query($con, "SELECT * FROM CLIENTES ORDER BY nom_cliente ASC");
				}
					...
					while($row = mysqli_fetch_assoc($sql)){
                        ...
                        <tbody>
                            <tr class=tr-shadow">
                                ...
                                <td>'.$row['ced_cliente'].'</td>
                                <td>
                                    <span class="block-email">'.$row['correo_cliente'].'</span>
                                </td>
                                <td>'.$row['tel_cliente'].'</td>
                                <td>'.$row['puntos_cliente'].'</td>
                                <td>
                                
                                    <div class="table-data-feature">
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="ClientesEditar.php?aksi=delete&nik='.$row['cod_cliente'].'&mensaje='.$mensaje.'">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Delete" href="ClientesCRUD.php?aksi=delete&nik='.$row['cod_cliente'].'&mensaje='.$mensaje.'">

    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				$cek = mysqli_query($con, "SELECT * FROM EMPLEADOS WHERE cod_empleado ='$nik'");
                ...
                {
                    $delete = mysqli_query($con, "DELETE FROM EMPLEADOS WHERE cod_empleado ='$nik'");
            ...
            <div class="main-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a class="au-btn au-btn-icon au-btn--green au-btn--small" href='EmpleadosAgregar.php?mensaje=<?php echo $mensaje?>'><i class="zmdi zmdi-plus"></i>Agregar empleado</a>
			    ...
			    if($filter)
				{
				$sql = mysqli_query($con, "SELECT * FROM EMPLEADOS WHERE nom_empleado LIKE '%$filter%' ORDER BY nom_empleado ASC");
				}
			    else
				{
				$sql = mysqli_query($con, "SELECT * FROM EMPLEADOS ORDER BY nom_empleado ASC");
				}
				if(mysqli_num_rows($sql) == 0){
                    ...
                    while($row = mysqli_fetch_assoc($sql))
                    {
                        ...
                        $sql_cargo = "SELECT * FROM CARGO INNER JOIN EMPLEADOS ON EMPLEADOS.cod_cargo = CARGO.cod_cargo WHERE EMPLEADOS.cod_empleado = '$row[cod_empleado]'";
                        ...
                        <tbody>
                            <tr class=tr-shadow">
                                ...
                                <td>'.$row['ced_empleado'].'</td>
                                <td>'.$row['tel_empleado'].'</td>
                                <td>'.$row['fecha_ingreso_empleado'].'</td>
                                <td>'.$fila['nom_cargo'].'</td>
                                <td>'.$row['multiplex_empleado'].'</td>
                                <td>
                                
                                    <div class="table-data-feature">
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="EmpleadosEditar.php?aksi=delete&nik='.$row['cod_empleado'].'&mensaje='.$mensaje.'">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Delete" href="EmpleadosCRUD.php?aksi=delete&nik='.$row['cod_empleado'].'&mensaje='.$mensaje.'">

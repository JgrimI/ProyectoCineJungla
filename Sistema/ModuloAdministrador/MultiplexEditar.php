...
<?php
                        ...
                        $sql = mysqli_query($con, "SELECT * FROM MULTIPLEX WHERE cod_multiplex='$nik'");
                ...
                {
					$sql = "UPDATE MULTIPLEX SET nom_multiplex = '$nombre', dir_multiplex = '$dir' WHERE cod_multiplex= '$nik'";
                        ...
                        <div class="login-form">
                            <form class="form-horizontal" enctype="multipart/form-data" action="" method="post">
                                <div class="form-group">
                                    <label>Nombre</label>
                                    <input class="au-input au-input--full" type="text" name="nombre" placeholder="" value="<?php echo $row ['nom_multiplex']; ?>">
                                </div>
                                <div class="form-group">
                                    <label>Dirección</label>
                                    <input class="au-input au-input--full" type="text" name="dir" placeholder="" value="<?php echo $row ['dir_multiplex']; ?>">
                                </div>
                               
                                <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit" name="save">Actualizar Multiplex</button>
                            </form>
                        </div>
                    </div>
                </div>

    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
			...
			if(isset($_GET['aksi']) == 'delete'){
				...
				$cek = mysqli_query($con, "SELECT * FROM MULTIPLEX WHERE cod_multiplex ='$nik'");
				if(mysqli_num_rows($cek) == 0){
					echo 'No se puedo eliminar';
				}else{
                    $delete = mysqli_query($con, "DELETE FROM MULTIPLEX WHERE cod_multiplex ='$nik'");
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Multiplex</h3>
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a class="au-btn au-btn-icon au-btn--green au-btn--small" href='MultiplexAgregar.php?mensaje=<?php echo $mensaje?>'><i class="zmdi zmdi-plus"></i>Agregar Multiplex</a>
			    ...
			    if($filter)
				{
				$sql = mysqli_query($con, "SELECT * FROM MULTIPLEX WHERE nom_multiplex LIKE '%$filter%' ORDER BY nom_multiplex ASC");
				}
			    else
				{
				$sql = mysqli_query($con, "SELECT * FROM MULTIPLEX ORDER BY nom_multiplex ASC");
				}
				if(mysqli_num_rows($sql) == 0){
					...
					while($row = mysqli_fetch_assoc($sql)){
                        ...
                        <tbody>
                            <tr class=tr-shadow">
                                <td>'.$no.'</td>
                                <td>'.$row['nom_multiplex'].'</td>
                                <td>'.$row['dir_multiplex'].'</td>
                               
                                <td>
                                    <div class="table-data-feature">
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="MultiplexEditar.php?aksi=delete&nik='.$row['cod_multiplex'].'&mensaje='.$mensaje.'">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Delete" href="MultiplexCRUD.php?aksi=delete&nik='.$row['cod_multiplex'].'&mensaje='.$mensaje.'">

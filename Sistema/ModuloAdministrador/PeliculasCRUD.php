    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
			...
			if(isset($_GET['aksi']) == 'delete'){
                ...
                {
                    $delete = mysqli_query($con, "DELETE FROM PELICULA WHERE cod_pelicula ='$nik'");
            ...
            <div class="main-content">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-data__tool">
                                    ...
                                    <div class="table-data__tool-right">
                                        <a class="au-btn au-btn-icon au-btn--green au-btn--small" href='PeliculasAgregar.php?mensaje=<?php echo $mensaje?>'><i class="zmdi zmdi-plus"></i>Agregar pelicula</a>
                                            <div class="rs-select2--dark rs-select2--sm rs-select2--dark2">
                                                <select class="js-select2" name="type" onchange="window.open(this.value, '_blank');">
                                                    <option selected="selected">Export</option>
                                                    <option value="Archivos/PeliculasPDF.php">PDF</option>
                                                    <option value="Archivos/PeliculasExcel.php">Excel</option>
                                                </select>
			    ...
			    if($filter)
				{
				$sql = mysqli_query($con, "SELECT * FROM PELICULA WHERE nom_pelicula LIKE '%$filter%' ORDER BY nom_pelicula ASC");
				}
			    else
				{
				...
				if(mysqli_num_rows($sql) == 0){
                    ...
                    while($row = mysqli_fetch_assoc($sql))
                    {
                        ...
                        <tbody>
                            <tr class=tr-shadow">
                                <td>'.$no.'</td>
                                <td>'.$row['nom_pelicula'].'</td>
                                <td>'.$row['idioma_pelicula'].'</td>
                                <td>'.$row['fecha_pelicula'].'</td>
                                <td>'.$row['duracion_pelicula'].'</td>
                                <td>
                                
                                    <div class="table-data-feature">
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Edit" href="PeliculasEditar.php?aksi=delete&nik='.$row['cod_pelicula'].'&mensaje='.$mensaje.'">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a class="item" data-toggle="tooltip" data-placement="top" title="Delete" href="PeliculasCRUD.php?aksi=delete&nik='.$row['cod_pelicula'].'&mensaje='.$mensaje.'">
